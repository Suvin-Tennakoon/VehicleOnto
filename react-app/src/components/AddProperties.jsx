...
const AddProperties = ({ selectedTaxonomy }) => {
    ...
    <div>
      ...
      >
        ...
        <div
          className="flex justify-between gap-6 items-center text-fontcolor"
        ...
        <div
          className="w-full border-b-2 mt-6 border-lightgray"
          id="view_property"
        ></div>
          ...
          <tbody className="text-sm h-32 flex flex-col items-center overflow-y-auto w-full">
            {propertiesList?.map((property, index) => (
              ...
              >
                ...
                <td className="pl-2 py-2 w-1/5 flex justify-between">
                  {property.functional}
                  <MdDeleteOutline
